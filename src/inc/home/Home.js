		...
		return (
			<div className="home">
				<div className="banner01">
					...
					<a className="btnDowload01" target="_blank" href="http://hannacastor.com.br/PDF/Presentation_HannaCastorBranding.pdf">BAIXE NOSSA APRESENTAÇÃO</a>
					...
					<div className="feito_com_amor">
						...
						<p>atendimendo@hannacastor.com.br</p>
